...
const CalculadoraEnergia = () => {
    ...
    const faqItems = [
        {
            question: "Quantas placas solares para uma casa?",
            answer: "Depende do consumo mensal em kWh, da irradiacao da regiao e da potencia dos paineis. O dimensionamento correto e feito a partir da conta de luz."
        },
        {
            question: "Quanto custa instalar energia solar residencial?",
            answer: "O valor varia com o tamanho do sistema em kWp, marca dos equipamentos e mao de obra local. Em geral, o custo cresce conforme a demanda de geracao."
        },
        {
            question: "Em quanto tempo energia solar se paga?",
            answer: "O payback costuma variar conforme tarifa local, irradiacao e investimento inicial. Em muitos cenarios residenciais, ocorre entre 3 e 6 anos."
        }
    ];
