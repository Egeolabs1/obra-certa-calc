...
const CalculadoraTinta = () => {
  ...
  const faqItems = [
    {
      question: "18 litros de tinta pinta quantos metros quadrados?",
      answer: "Depende do rendimento da tinta e do numero de demaos. Em media, 18L rendem de 72m2 a 270m2 por demao. Com 2 demaos, essa area e reduzida pela metade."
    },
    {
      question: "3,6 litros de tinta cobre quantos metros?",
      answer: "Com rendimento medio de 10m2/L, 3,6L cobrem cerca de 36m2 por demao. Com 2 demaos, cobrem aproximadamente 18m2."
    },
    {
      question: "Como calcular tinta por metro quadrado?",
      answer: "Some a area das paredes e teto, desconte portas e janelas, divida pelo rendimento da tinta e multiplique pelo numero de demaos."
    }
  ];
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      <SEO
        title="Calculadora de Tinta: quantos litros por m2"
        description="Descubra quantos litros de tinta voce precisa por metro quadrado. Calcule paredes e teto, demaos e rendimento para evitar desperdicio."
        url="https://www.suaobracerta.com.br/calculadora-tinta"
        keywords="calculadora de tinta, quantos litros de tinta por metro quadrado, 18 litros de tinta pinta quantos metros, 3,6 litros de tinta cobre quantos metros, como calcular tinta por m2, rendimento de tinta por demao, tinta parede m2"
        schema={[
      ...
      <main className="flex-1">
        ...
        <div className="container py-8 md:py-12 print:py-0">
          <div className="mx-auto max-w-2xl print:max-w-full">
            ...
            <div className="mb-8 animate-fade-up print:hidden">
              <div className="mb-4 flex items-center gap-3">
                ...
                <h1 className="text-2xl font-bold text-foreground md:text-3xl">
                  Calculadora de Tinta (Litros por m2)
                </h1>
              </div>
            ...
            <div className="mb-6 rounded-xl border border-border bg-muted/30 p-4 text-sm text-muted-foreground print:hidden">
              <p className="font-medium text-foreground mb-2">Atalhos rapidos de duvidas comuns:</p>
              <ul className="list-disc list-inside space-y-1">
                <li><strong>18L:</strong> normalmente cobre de 72m2 a 270m2 por demao.</li>
                <li><strong>3,6L:</strong> normalmente cobre de 14,4m2 a 54m2 por demao.</li>
                <li><strong>Regra:</strong> area total / rendimento x numero de demaos.</li>
              </ul>
            </div>
