...
const CalculadoraChurrasco = () => {
    ...
    const compartilharWhatsApp = () => {
        ...
        const texto = `🔥 *Churrasco 3.0 - Sua Obra Certa*\n` +
            ...
            `Calculado em: https://www.suaobracerta.com.br/calculadora-churrasco`;
    ...
    return (
        <div className="flex min-h-screen flex-col bg-background">
            <SEO
                ...
                url="https://www.suaobracerta.com.br/calculadora-churrasco"
                schema={generateCalculatorSchema(
                    "Calculadora de Churrasco",
                    "Calcule a quantidade exata de carne e bebidas para seu churrasco, com divisão de custos.",
                    "https://www.suaobracerta.com.br/calculadora-churrasco"
                )}
            />
