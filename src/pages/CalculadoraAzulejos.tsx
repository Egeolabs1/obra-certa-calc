...
const CalculadoraAzulejos = () => {
    ...
    const faqItems = [
        {
            question: "Como calcular azulejo por metro quadrado?",
            answer: "Calcule a area total em m2, aplique a margem de perdas e divida pela area de cada peca em m2."
        },
        {
            question: "Quantos azulejos 60x60 por metro quadrado?",
            answer: "Cada peca 60x60 cobre 0,36m2. Portanto, cabem aproximadamente 2,78 pecas por m2, sem considerar perdas."
        },
        {
            question: "Qual margem de quebra usar em azulejo e piso?",
            answer: "Use 10 por cento em assentamento reto e 15 por cento ou mais para assentamento diagonal ou com muitos recortes."
        }
    ];
    ...
    return (
        <div className="flex min-h-screen flex-col bg-background">
            <SEO
                ...
                url="https://www.suaobracerta.com.br/calculadora-azulejos"
                schema={[
                    generateCalculatorSchema(
                        "Calculadora de Azulejos",
                        "Cálculo de quantidade de revestimentos cerâmicos e porcelanatos.",
                        "https://www.suaobracerta.com.br/calculadora-azulejos"
                    ),
