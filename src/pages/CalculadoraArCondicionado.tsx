...
const CalculadoraArCondicionado = () => {
    ...
    const faqItems = [
        {
            question: "Como calcular BTU por metro quadrado?",
            answer: "Como referencia geral, use 600 BTU por m2 para ambientes com pouco sol e 800 BTU por m2 para sol forte, ajustando por pessoas e eletronicos."
        },
        {
            question: "Qual ar condicionado para quarto de 12m2?",
            answer: "Em muitos casos, 9000 BTUs atende bem. Em quarto muito quente, com muito sol da tarde, pode ser necessario subir para 12000 BTUs."
        },
        {
            question: "Ar condicionado inverter economiza energia?",
            answer: "Sim. Modelos inverter costumam consumir menos energia por manter o compressor modulando a potencia, em vez de ligar e desligar continuamente."
        }
    ];
    ...
    return (
        <div className="flex min-h-screen flex-col bg-background">
            <SEO
                title="Calculadora de BTU Ar Condicionado"
                description="Calcule BTUs ideais para quarto, sala e escritorio com base em area, sol, pessoas e eletrônicos."
