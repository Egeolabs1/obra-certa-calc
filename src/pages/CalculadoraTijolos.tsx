...
const CalculadoraTijolos = () => {
  ...
  const faqItems = [
    {
      question: "Quantos tijolos por metro quadrado?",
      answer: "Depende do tipo de tijolo. Em media: 6 furos ~25 un/m2, 9 furos ~22 un/m2, baiano ~16 un/m2 e macico ~75 un/m2."
    },
    {
      question: "Como calcular quantidade de tijolos para parede?",
      answer: "Calcule a area da parede (altura x comprimento), desconte portas e janelas, multiplique pelo consumo por m2 do tijolo e adicione margem de perdas."
    },
    {
      question: "Qual margem de perda usar para tijolos?",
      answer: "Na maioria das obras residenciais, 10 por cento e uma margem segura. Em paredes com muitos recortes, use 15 por cento."
    }
  ];
