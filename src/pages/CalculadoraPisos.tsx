...
const CalculadoraPisos = () => {
  ...
  const faqItems = [
    {
      question: "Como calcular quantas caixas de piso vou usar?",
      answer: "Calcule a area do ambiente, desconte moveis fixos, adicione margem de corte e divida pela area coberta por caixa."
    },
    {
      question: "Qual margem de perda usar para piso e porcelanato?",
      answer: "Em pagina simples, use 10 por cento. Em diagonal ou com muitos recortes, use de 15 a 20 por cento."
    },
    {
      question: "Quantas pecas de piso por metro quadrado?",
      answer: "Depende do formato da peca. A quantidade vem de 1 dividido pela area da peca em m2."
    }
  ];
      ...
      <SEO
        ...
        schema={[
          generateCalculatorSchema(
            ...
            "https://www.suaobracerta.com.br/calculadora-pisos"
          ),
